...
const Shop = () => {
    ...
    useEffect(()=>{
        fetch('https://secure-plateau-02196.herokuapp.com/products?search='+search)
        .then(res=>res.json())
    ...
    return (
        <div className="twin-container">
            <div className="product-container">
                <input className='product-search' onBlur={handleSearch} type="text"/>
                {
            ...
            <div className="cart-container">
                <Cart cart={cart}>
                    <Link to="/review">
                        <button className="add-cart-button">Review Order</button>
                    </Link>
                </Cart>
            </div>
        </div>
